...
# From: tuturuatu_all (2_1_pretidyup_stats_tuturuatu_all.sh)
...
#Plotting mosdepth outputs.
    python ~/data/general_scripts/plot-dist.py ${sppdir}dup_bam_stats/*.global.dist.txt > ${sppdir}dup_bam_stats/dup_bam_plot_dist_tutu_all.html
