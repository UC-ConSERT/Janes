...
# Concordance
    ...
    do
        ...
        do
            file=${evaldir}Tuturuatu_VariantCalls_${dp}x_${test_ne}ne_${run}_final.vcf.gz
            ...
            # Concordance
            gatk Concordance -eval ${file} --truth ${truthvcf} --summary ${statsdir}concordance/${run}_${dp}x_${test_ne}ne_concordance_summary.tsv
        done
    done
