...
bquerydir=${sppdir}bcf/filter_strand_bias_bcftools_query/vcf/
    #directory of strand bias filtered bcfs from bcftools query

mkdir -p ${sppdir}bcf/strand_bias_filter_stats/vcf/
statsdir=${sppdir}bcf/strand_bias_filter_stats/vcf/
...
echo " (5_3) Calculating stats beginning. Please do not wear 3D glasses."
    ...
    statscsv=${statsdir}mean_SD_filter_stats_tuturuatu_all_strand_bias_vcf_23.csv
