...
echo ", Mean Site Depth,SD,Mean Indv Depth,SD,Mean Site Missingness,SD,Mean Indv Missingness,SD,Mean Heterozygosity, Mean Heterozygosity SD">>mean_SD_filter_stats_tuturuatu_trial_2_22.csv 
...
echo "${base}, ${site_depth_mean}, ${site_depth_SD}, ${indv_depth_mean}, \
    ...
    ${indv_miss_SD}, ${het_mean}, ${het_SD}" >> mean_SD_filter_stats_tuturuatu_trial_2_22.csv  
done 
