...
cd ~/Documents/Tuturuatu_resources/tuturuatu_all/
...
#   Dup graphmaps
    ...
    for file in ${dupdir}*.graphmap    #define file as the sample's graphmap folders
    do 
...
#   Nodup graphmaps
    ...
    for file in ${nodupdir}*.graphmap    #define file as the sample's graphmap folders
    do 
